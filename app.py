...
def main():
    ...
    if option == 'About':
        ...
        st.write("- Developer 1: Rumman Parvez(LinkedIn profile link)")
        st.write("- Developer 2: Kanishk Bajpai(LinkedIn profile link)")
        st.write("- Developer 3: Kaushal Singh Rana(LinkedIn profile link)")
        st.write("- Developer 3: Kaushal Singh Rana(LinkedIn profile link)")
